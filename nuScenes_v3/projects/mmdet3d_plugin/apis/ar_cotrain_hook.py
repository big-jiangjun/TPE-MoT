"""
AR Cotraining Hook for TPE-MoT
...
class ARCotrainingHook(Hook):
    ...
    def before_run(self, runner):
        ...
        Supports two modes:
        1. Single dataset: jsonl_paths / jsonl_path  鈫? one ARPlanningQADataset
        2. Mixed dataset:  driving_jsonl_paths + vqa_jsonl_paths  鈫? InterleaveDataset
        ...
        try:
            ...
            if hasattr(model, 'module'):
                perception_head = model.module.perception_head
            else:
                perception_head = model.perception_head

            if hasattr(perception_head, 'qwen3_vl_with_expert'):
                pass  # existence check only
            else:
                raise AttributeError("Cannot find qwen3_vl_with_expert in perception_head")

            processor = perception_head.qwen3_vl_with_expert.processor
            ...
            if vqa_paths is not None and driving_paths is not None:
                # 鈹€鈹€ Mixed mode: interleave driving + VQA 1:1 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
                ...
                runner.logger.info(
                    ...
                    f"鈫?{len(ar_dataset)} interleaved samples"
                )
            else:
                # 鈹€鈹€ Single dataset mode 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
            ...
            # 鈹€鈹€ DistributedSampler: each GPU loads its own non-overlapping shard 鈹€鈹€
